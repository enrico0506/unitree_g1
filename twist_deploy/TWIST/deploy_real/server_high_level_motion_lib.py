...
import json
import numpy as np
# Was: import isaacgym — NVIDIA-GPU-only, not installed (AMD GPU here), and
# not actually needed for this script's own logic; see the shim comment in
# pose/utils/torch_utils.py for the real dependency this was standing in for.
import torch
