"""Dashboard-side thin client for the object-detect lane.

The detect container (detect_service.py) writes geometry to shm; this class
...
class DetectClient:
    ...
    def demand(self):
        """Heartbeat: detect container only infers while watched."""
        try:
    ...
    def tracks(self):
        """{w, h, items:[{cls, conf, box}]}, or an empty default."""
        try:
